...
?>
        ...
        <div class="input-group">
          <textarea style="width: 75%; border-top-left-radius: 5px;    border-bottom-left-radius: 5px; height: 150px; margin-left: 15px; margin-right: 15px; margin-top: 5px; margin-bottom: 5px;" rows="3" id="detail" class="form-control validate" name="detail" value="<?php echo $detail; ?>"><?php echo $detail; ?></textarea>
        </div>
        <div class="input-group">
      ...
      <div class="d-flex">
        <button type="submit" name="done" class="btn btn-success"><img src="image/check.png"></button>
      </div>
      <div class="d-flex">
        <button type="submit" name="save" class="btn btn-info"><img src="image/save.png"></button>
      </div>
      <div class="d-flex">
        <button type="submit" class="btn btn-danger" name="deletebutton"><img src="image/delete.png"></button> 
      </div>  
      </div>
    </div>
    </form>
